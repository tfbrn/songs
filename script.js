...
function hsementara() {
  ketgeser.style = "position:relative;padding-bottom:25px;";
  thisgeser += 1;
  aktigeser = 0;
...
function munculkembali() {
  if (thisgeser < totalPesan) {
    ketgeser.style = "position:relative;transform:scale(1);opacity:.8;padding-bottom:25px;";
    aktigeser = 1;
  }
...
function ftmuncul() {
  ...
  if (ftganti == 1)
    fotostiker.style = "display:inline-flex;opacity:1;transform:scale(1);width:120px;height:120px;background:none;box-shadow:none;border:none;border-radius:0";

  if (ftganti == 9)
    fotostiker.style = "display:inline-flex;opacity:0;transform:scale(1);background:none;box-shadow:none;border:none;border-radius:0";
...
function fthilang() {
  ...
  if (ftganti <= 11) setTimeout(ftmuncul, 250);
  if (ftganti >= 12) wallpaper.style = "opacity:.7;transform: scale(2);";
}
